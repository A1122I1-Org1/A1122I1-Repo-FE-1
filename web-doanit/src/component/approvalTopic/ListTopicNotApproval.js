...
function ListTopicNotApproval() {
    ...
    return topics.length !== 0 ? (
        <>
            <div className="headerTuanHA" style={{marginTop:"60px"}}>
                ...
                <div id="cancelForm" style={{padding: '20px', maxWidth: '600px', margin: 'auto'}}
                                            ...
                                            <div className="form-group">
                                                <div className="col-sm">
                                                    <label htmlFor="contentTopic"
                                                           style={{fontWeight: 'bold', fontSize: '14px'}}>Nội dung
                                                        nguyên
                                                        nhân hủy.</label>
                                                    <Field
                                    ...
                                    <div className="col-sm" style={{padding: '20px'}}>
                                        <Form>
                                            ...
                                            <div className="d-grid gap-2">
                                                <button type="button" className="btn btn-outline-secondary">Thêm mới
                                                    giai
                                                    đoạn
                                                </button>
                                                <button type="submit" className="btn btn-success">Duyệt</button>
                                                <button className="btn btn-outline-info"
                                                        onClick={turnOffFormApproval}>Hủy
                                                </button>
                                            </div>
                                        </Form>
                                    </div>
